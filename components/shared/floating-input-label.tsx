      ...
      <div className="relative">
        <input
          ...
          className={cn(
            ...
            "text-[15px] leading-6 text-black dark:text-white outline-none transition-all",
            "border-zinc-300",
        ...
        <label
          ...
          className={cn(
            ...
            "peer-focus:top-2 peer-focus:translate-y-0 peer-focus:text-xs peer-focus:text-[#1d9bf0]",
